    ...
    <>
      ...
      >
        <div className="flex items-center gap-0.5">
          ...
          {/* Separator + Available badge */}
          <div className="ml-2 pl-2.5 border-l border-white/8 flex items-center gap-1.5 shrink-0">
            <span className="relative flex h-1.5 w-1.5">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" />
              <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-emerald-500" />
            </span>
            <span className="text-[10px] font-mono text-emerald-400 font-semibold tracking-wide whitespace-nowrap hidden sm:inline">
              Available
            </span>
          </div>
        </div>
